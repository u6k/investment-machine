...
RSpec.describe InvestmentStocks::Crawler::Parser::TopixCsvParser do
  ...
  describe "#parse" do
    ...
    context "existing data" do
      before do
        InvestmentStocks::Crawler::Model::Topix.create(date: Time.new(1989, 12, 31), opening_price: 1989.1231, high_price: 1989.1231, low_price: 1989.1231, close_price: 1989.1231)
        InvestmentStocks::Crawler::Model::Topix.create(date: Time.new(1990,  1,  1), opening_price: 1990.0101, high_price: 1990.0101, low_price: 1990.0101, close_price: 1990.0101)
        InvestmentStocks::Crawler::Model::Topix.create(date: Time.new(1990, 12, 31), opening_price: 1990.1231, high_price: 1990.1231, low_price: 1990.1231, close_price: 1990.1231)
        InvestmentStocks::Crawler::Model::Topix.create(date: Time.new(1991,  1,  1), opening_price: 1991.0101, high_price: 1991.0101, low_price: 1991.0101, close_price: 1991.0101)
      end
