...
RSpec.describe InvestmentStocks::Crawler::Parser::DjiaCsvParser do
  ...
  describe "#parse" do
    ...
    context "existing data" do
      before do
        InvestmentStocks::Crawler::Model::Djia.create(date: Time.new(1989,  1,  1), opening_price: 1989.0101, high_price: 1989.0101, low_price: 1989.0101, close_price: 1989.0101)
        InvestmentStocks::Crawler::Model::Djia.create(date: Time.new(1989, 12, 31), opening_price: 1989.1231, high_price: 1989.1231, low_price: 1989.1231, close_price: 1989.1231)
        InvestmentStocks::Crawler::Model::Djia.create(date: Time.new(1990,  1,  1), opening_price: 1990.0101, high_price: 1990.0101, low_price: 1990.0101, close_price: 1990.0101)
        InvestmentStocks::Crawler::Model::Djia.create(date: Time.new(1990, 12, 31), opening_price: 1990.1231, high_price: 1990.1231, low_price: 1990.1231, close_price: 1990.1231)
        InvestmentStocks::Crawler::Model::Djia.create(date: Time.new(1991,  1,  1), opening_price: 1991.0101, high_price: 1991.0101, low_price: 1991.0101, close_price: 1991.0101)
        InvestmentStocks::Crawler::Model::Djia.create(date: Time.new(1991, 12, 31), opening_price: 1991.1231, high_price: 1991.1231, low_price: 1991.1231, close_price: 1991.1231)
      end
      ...
      it "is prices" do
        ...
        expect(InvestmentStocks::Crawler::Model::Djia.all).to match_array([
          have_attributes(date: Time.local(1989,  1,  1), opening_price: 1989.0101, high_price: 1989.0101, low_price: 1989.0101, close_price: 1989.0101),
          have_attributes(date: Time.local(1989, 12, 31), opening_price: 1989.1231, high_price: 1989.1231, low_price: 1989.1231, close_price: 1989.1231),
          have_attributes(date: Time.local(1991,  1,  1), opening_price: 1991.0101, high_price: 1991.0101, low_price: 1991.0101, close_price: 1991.0101),
          have_attributes(date: Time.local(1991, 12, 31), opening_price: 1991.1231, high_price: 1991.1231, low_price: 1991.1231, close_price: 1991.1231),
